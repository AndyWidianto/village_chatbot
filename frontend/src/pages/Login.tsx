  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 bg-white/70 dark:bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] border border-white dark:border-slate-800 shadow-2xl overflow-hidden relative z-10">
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-orange-600 to-orange-400 text-white relative">
          <div className="relative z-10">
            ...
            <p className="text-orange-50/80 max-w-sm">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-100 dark:bg-slate-800/50 border-transparent focus:border-orange-500 focus:bg-white dark:focus:bg-slate-800 rounded-2xl transition-all duration-200 outline-none ring-0 focus:ring-4 focus:ring-orange-500/10 text-slate-800 dark:text-white"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <a href="#" className="text-xs font-bold text-orange-500 hover:text-orange-600">Lupa Password?</a>
              </div>
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-slate-100 dark:bg-slate-800/50 border-transparent focus:border-orange-500 focus:bg-white dark:focus:bg-slate-800 rounded-2xl transition-all duration-200 outline-none ring-0 focus:ring-4 focus:ring-orange-500/10 text-slate-800 dark:text-white"
                />
                <button 
                  type="button"
            ...
            <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-orange-500/30 transition-all duration-300 flex items-center justify-center gap-2 group">
